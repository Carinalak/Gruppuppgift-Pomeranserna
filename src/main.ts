...
export let newQuizBox: QuizQuestion[] = [
	...
	{
		question:
			"Vilken skådespelare spelar Tony Stark, också känd som Iron Man, i Marvel Cinematic Universe?",
	...
	{
		question:
			"Vilken film från 1997, regisserad av James Cameron, handlar om en olycka med ett berömt skepp?",
	...
	{
		question:
			'Vem spelade huvudrollen i filmen "Pirates of the Caribbean" som Kapten Jack Sparrow?',
	...
	{
		question:
			"Vilken film, baserad på en bok av J.K. Rowling, introducerar karaktären Harry Potter?",
